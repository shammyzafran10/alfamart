      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="tambah_metode_pembayaran.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH DATA</a>
              <table class="table table-bordered" id_metode_pembayaran="myTable">
                <thead>
                  <tr>
                    
                    <th scope="col">NO</th>
                    <th scope="col">NAMA metode_pembayaran</th>                   
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit_metode_pembayaran.php?id=<?php echo $row['id_metode_pembayaran'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus_metode_pembayaran.php?id=<?php echo $row['id_metode_pembayaran'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>

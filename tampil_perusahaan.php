      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="tambah_perusahaan.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH DATA</a>
              <table class="table table-bordered" id_perusahaan="myTable">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit_perusahaan.php?id=<?php echo $row['id_perusahaan'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus_perusahaan.php?id=<?php echo $row['id_perusahaan'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>

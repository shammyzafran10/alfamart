            ...
            <div class="card-body">
              <form action="update_member.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_member" value="<?php echo $row['nama_member'] ?>" placeholder="Masukkan Nama member" class="form-control"required>
                  <input type="hidden" name="id_member" value="<?php echo $row['id_member'] ?>">
                </div>

                <div class="form-group">
                  <label>No Telp</label>
                  <input type="text" name="no_telp" value="<?php echo $row['no_telp'] ?>" placeholder="Masukkan No Telepon member" class="form-control"required>
                </div>

                <div class="form-group">
                  <label>Alamat</label>
                  <textarea class="form-control" name="alamat"   placeholder="Masukkan Alamat Member" rows="4"required><?php echo $row['alamat'] ?></textarea>
                </div>

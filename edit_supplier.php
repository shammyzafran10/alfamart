            ...
            <div class="card-body">
              <form action="update_supplier.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_supplier" value="<?php echo $row['nama_supplier'] ?>" placeholder="Masukkan Nama Supplier" class="form-control"required>
                  <input type="hidden" name="id_supplier" value="<?php echo $row['id_supplier'] ?>">
                </div>

                <div class="form-group">
                  <label>NO HP</label>
                  <input type="text" name="no_hp" value="<?php echo $row['no_hp'] ?>" placeholder="Masukkan Stock Supplier" class="form-control"required>
                </div>

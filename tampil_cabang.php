      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="tambah_cabang.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH DATA</a>
              <table class="table table-bordered" id_cabang="myTable">
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php 
                     ...
                     $no= 1 ;
                      ...
                      $query = mysqli_query($connection,"SELECT * FROM cabang inner join  perusahaan on perusahaan.id_perusahaan=cabang.id_perusahaan");
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit_cabang.php?id=<?php echo $row['id_cabang'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus_cabang.php?id=<?php echo $row['id_cabang'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>

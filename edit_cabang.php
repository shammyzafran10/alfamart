            ...
            <div class="card-body">
              <form action="update_cabang.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_cabang" value="<?php echo $row['nama_cabang'] ?>" placeholder="Masukkan Nama cabang" class="form-control" required>
                  <input type="hidden" name="id_cabang" value="<?php echo $row['id_cabang'] ?>">
                </div>

                <div class="form-group">
                  <label>Alamat</label>
                  <textarea class="form-control" name="alamat_cabang"   placeholder="Masukkan Alamat Cabang" rows="4" required><?php echo $row['alamat_cabang'] ?></textarea>
                </div>

                <div class="form-group">
                  <label>Nomor Telp</label>
                  <input type="text" name="nomor_telp" value="<?php echo $row['nomor_telp'] ?>" placeholder="Masukkan nomor_telp cabang" class="form-control" required>
                </div>

                <div class="form-group">
                  <label>Email</label>
                  <input type="text" name="email" value="<?php echo $row['email'] ?>" placeholder="Masukkan Harga Jual cabang" class="form-control" required>
                </div>

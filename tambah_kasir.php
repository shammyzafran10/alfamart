    ...
    <div class="form-group">
        <input type="hidden" name="id_kasir" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_kasir" placeholder="Masukkan Nama kasir" class="form-control"required>
                </div>

                <div class="form-group">
                  <label>Alamat</label>
                  <textarea class="form-control" name="alamat_kasir" placeholder="Masukkan Alamat Kasir" rows="4"required></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nomor_telp" placeholder="Masukkan NOMOR TELP kasir" class="form-control"required>
                </div>
